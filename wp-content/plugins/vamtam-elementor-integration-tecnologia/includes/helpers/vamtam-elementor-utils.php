...
class Vamtam_Elementor_Utils {
	...
	protected static function handle_responsive_prefix_class_option( $controls_manager, $element, $control_id, &$control_data ) {
	...
	protected static function update_control_options( $controls_manager, $element, string $control_id, array $options, bool $replace ) {
		...
		if ( $is_responsive ) {
			if ( isset( $control_data[ 'prefix_class' ] ) ) {
				...
				self::handle_responsive_prefix_class_option( $controls_manager, $element, $control_id, $control_data );
