...
if ( isset($_GET["rsssl_header_test"]) && (int) $_GET["rsssl_header_test"] ===  97633174 ) return;

if ( defined("RSSSL_HEADERS_ACTIVE" ) ) return;
define( "RSSSL_HEADERS_ACTIVE", true );
if ( file_exists( "/home/customer/www/q4gems.com/public_html/wp-content/firewall.php" ) ) {
    require_once "/home/customer/www/q4gems.com/public_html/wp-content/firewall.php";
}
...
$is_rest_request = isset($_SERVER["REQUEST_URI"]) && (strpos($_SERVER["REQUEST_URI"], "wp-json/")!==false || strpos($_SERVER["REQUEST_URI"], "rest_route=")!==false) && isset($_SERVER["HTTP_X_WP_NONCE"]);
